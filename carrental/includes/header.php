...
<header>
  <div class="default-header">
        ...
        <div class="col-sm-9 col-md-10">
          <div class="header_info">
            <div class="header_widgets">
              ...
              <p class="uppercase_text">Mail поддержки : </p>
              <a href="https://www.bsuir.by" target="_blank">bsuir.by</a> </div>
            <div class="header_widgets">
              <div class="circle_icon"> <i class="fa fa-phone" aria-hidden="true"></i> </div>
              <p class="uppercase_text">Телефон поддержки пользователей: </p>
              <a href="tel:61-1234-5678-09">+375 17 293-86-01</a> </div>
   ...
   <?php   if(strlen($_SESSION['login'])==0)
	{	
?>
 <div class="login_btn"> <a href="#loginform" class="btn btn-xs uppercase" data-toggle="modal" data-dismiss="modal">Войти / Регистрация</a> </div>
<?php }
else{ 

echo "Добро рожаловать на WHEEL";
 } ?>
          </div>
        </div>
      </div>
...
foreach($results as $result)
	{
	 ...
	 echo htmlentities($result->FullName); }}?><i class="fa fa-angle-down" aria-hidden="true"></i></a>
           ...
           <?php if($_SESSION['login']){?>
            ...
            <li><a href="my-booking.php">Мои автомобили</a></li>
          ...
          <li><a href="my-testimonials.php">Мои отзывы</a></li>
            ...
            <li><a href="#loginform"  data-toggle="modal" data-dismiss="modal">Мои автомобили</a></li>
          ...
          <li><a href="#loginform"  data-toggle="modal" data-dismiss="modal">Мои отзывы</a></li>
            <li><a href="#loginform"  data-toggle="modal" data-dismiss="modal">Выйти из профиля</a></li>
            <?php } ?>
          </ul>
            </li>
          </ul>
      ...
      <div class="collapse navbar-collapse" id="navigation">
        <ul class="nav navbar-nav">
          ...
          <li><a href="car-listing.php">Каталог</a>
