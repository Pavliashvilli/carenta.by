    ...
    <div class="row">
      ...
      <div class="col-md-6 col-sm-8">
        <div class="profile_wrap">
          ...
          <?php  
         if($msg){?><div class="succWrap"><strong>УСПЕШНО</strong>:<?php echo htmlentities($msg); ?> </div><?php }?>
          <form  method="post">
           <div class="form-group">
            ...
            <div class="form-group">
              <label class="control-label">Последнее обновление  -</label>
            ...
            <div class="form-group">
              <button type="submit" name="updateprofile" class="btn">Сохранить <span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></button>
            </div>
          </form>
        </div>
      </div>
